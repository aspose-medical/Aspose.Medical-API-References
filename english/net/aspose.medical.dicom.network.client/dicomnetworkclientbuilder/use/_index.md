...
description: Registers a shared unary request behavior for client request dispatch.
type: docs
weight: 450
url: /net/aspose.medical.dicom.network.client/dicomnetworkclientbuilder/use/
---

## Use&lt;TRequest,TResponse&gt;(IRequestBehavior&lt;TRequest, TResponse&gt;) {#use_3}

Registers a shared unary request behavior for client request dispatch.

```csharp
public DicomNetworkClientBuilder Use<TRequest, TResponse>(
...
Registers a unary request behavior factory for client request dispatch.
...
Registers an open unary request behavior factory for client request dispatch.

```csharp
public DicomNetworkClientBuilder Use(IOpenRequestBehaviorFactory factory)
```
...
Registers a shared stream request behavior for client stream request dispatch.
...
| Parameter | Description |
| --- | --- |
| TRequest | The stream request type processed by the behavior. |
...
Registers a stream request behavior factory for client stream request dispatch.
...
Registers an open stream request behavior factory for client stream request dispatch.

```csharp
public DicomNetworkClientBuilder Use(IOpenStreamRequestBehaviorFactory factory)
```
