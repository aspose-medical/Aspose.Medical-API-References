...
```csharp
public sealed class OtherFloat : ValueElement<float>, IBufferBackedElement<OtherFloat, float>
```
...
| override [ValueRepresentation](../../aspose.medical.dicom.elements/otherfloat/valuerepresentation) { get; } |  |

## Methods

| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/otherfloat/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;float&gt;? TypedBuffer)) |  |
