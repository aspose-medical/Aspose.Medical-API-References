...
public sealed class ShortString : EncodableMultiValuedTextElement, 
    IBufferBackedElement<ShortString, string>
```
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/shortstring/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
