...
public sealed class UnlimitedText : SingleValueTextElement, 
    IBufferBackedElement<UnlimitedText, string>
```
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/unlimitedtext/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
