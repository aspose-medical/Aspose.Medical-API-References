...
```csharp
public sealed class Time : MultiValueDateTextElement<TimeOnly>, IBufferBackedElement<Time, string>
```
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/time/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
