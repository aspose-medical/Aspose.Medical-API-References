...
public sealed class DateTime : MultiValueDateTextElement<DateTime>, 
    IBufferBackedElement<DateTime, string>
```
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/datetime/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
