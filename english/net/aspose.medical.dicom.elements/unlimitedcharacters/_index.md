...
description: Encapsulates the Unlimited Characters UC VR type. https//dicom.nema.org/medical/dicom/current/output/chtml/part05/sect_6.2.htmltextUnlimited20Characters.
type: docs
weight: 890
url: /net/aspose.medical.dicom.elements/unlimitedcharacters/
---

## UnlimitedCharacters class

Encapsulates the Unlimited Characters (UC) VR type. https://dicom.nema.org/medical/dicom/current/output/chtml/part05/sect_6.2.html#:~:text=Unlimited%20Characters.

```csharp
public sealed class UnlimitedCharacters : EncodableMultiValuedTextElement, 
    IBufferBackedElement<UnlimitedCharacters, string>
```
...
| Name | Description |
| --- | --- |
| [UnlimitedCharacters](unlimitedcharacters#constructor)(Tag, Span&lt;string&gt;) |  |
| [UnlimitedCharacters](unlimitedcharacters#constructor_2)(Tag, Span&lt;string&gt;, Encoding) |  |
| [UnlimitedCharacters](unlimitedcharacters#constructor_1)(Tag, Span&lt;string&gt;, Span&lt;Encoding&gt;) |  |
...
| override [ValueRepresentation](../../aspose.medical.dicom.elements/unlimitedcharacters/valuerepresentation) { get; } |  |

## Methods

| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/unlimitedcharacters/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
