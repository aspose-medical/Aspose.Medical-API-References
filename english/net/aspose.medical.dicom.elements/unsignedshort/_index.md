...
public sealed class UnsignedShort : ValueElement<ushort>, 
    IBufferBackedElement<UnsignedShort, ushort>
```
...
| Name | Description |
| --- | --- |
| [UnsignedShort](unsignedshort#constructor)(Tag, Span&lt;ushort&gt;) |  |
| [UnsignedShort](unsignedshort#constructor_1)(Tag, ushort) | Initializes a new instance of the [`UnsignedShort`](../unsignedshort) with the given *value* and *tag*. |
...
| override [ValueRepresentation](../../aspose.medical.dicom.elements/unsignedshort/valuerepresentation) { get; } |  |

## Methods

| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/unsignedshort/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;ushort&gt;? TypedBuffer)) |  |
...
| [Insert](../../aspose.medical.dicom.elements/valueelement`1/insert)(int, ushort) |  |
| [Remove](../../aspose.medical.dicom.elements/valueelement`1/remove)(ushort) |  |
| [RemoveAt](../../aspose.medical.dicom.elements/valueelement`1/removeat)(int) |  |
| [Replace](../../aspose.medical.dicom.elements/valueelement`1/replace)(IEnumerable&lt;ushort&gt;) |  |
