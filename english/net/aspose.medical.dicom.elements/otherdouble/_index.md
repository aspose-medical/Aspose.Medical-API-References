...
```csharp
public sealed class OtherDouble : ValueElement<double>, IBufferBackedElement<OtherDouble, double>
```
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/otherdouble/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;double&gt;? TypedBuffer)) |  |
