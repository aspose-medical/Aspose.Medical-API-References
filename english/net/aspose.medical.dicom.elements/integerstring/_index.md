...
Encapsulates the Integer String (IS) VR type. https://dicom.nema.org/medical/dicom/current/output/chtml/part05/sect_6.2.html#:~:text=IS-,Integer%20String,-A%20string%20of.

```csharp
public sealed class IntegerString : NumericMultiValueTextElement<int>, 
    IBufferBackedElement<IntegerString, string>
```
...
| Name | Description |
| --- | --- |
| [IntegerString](integerstring#constructor)(Tag, Span&lt;int&gt;) |  |
| [IntegerString](integerstring#constructor_1)(Tag, Span&lt;string&gt;) |  |
...
| override [ValueRepresentation](../../aspose.medical.dicom.elements/integerstring/valuerepresentation) { get; } |  |

## Methods

| Name | Description |
| --- | --- |
| static [Create](../../aspose.medical.dicom.elements/integerstring/create)(Tag, (IByteBuffer? ByteBuffer, ITypedBuffer&lt;string&gt;? TypedBuffer)) |  |
